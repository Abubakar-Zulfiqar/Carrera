...
const N_651 = (props) => {
    const data = {
        id: uuid(),
        name: "Carrera Glass Kettle",
        price: 159.99,
        image: `${process.env.PUBLIC_URL}/images/logged_out/kitchen/№651 01.jpg`,
    };
        ...
        <>
            ...
            <Container>
                <Grid container sx={{ marginTop: "15rem" }}>
                    ...
                    <Grid xs={6}>
                        <img
                            src={`${process.env.PUBLIC_URL}/images/logged_out/kitchen/№651 01.jpg`}
                            alt=""
                            style={{
            ...
            <Container>
                <Grid container sx={{ marginTop: "15rem" }}>
                    ...
                    >
                        ...
                        >
                            When it comes to features, both of the Carrera electric kettles are nearly identical. They both have a powerful 2200 Watt rating, multiple temperature select, a taste-neutral 1.7L thermal jug and a full 30 minute simmer setting. The only real difference between the two comes from their looks - stainless steel for those who like more industrial style and glass for those who like to watch the water boil.
                        </Typography>
                        <Box
                            pt={2}
                            sx={{
                    ...
                    <Grid xs={6}>
                        <img
                            src={`${process.env.PUBLIC_URL}/images/logged_out/kitchen/№651 04.jpg`}
                            alt=""
                            style={{
                                animationDuration: "1s",
                                animationName: "fadeInUp",
                ...
                >
                    ...
                    <Grid item xs={4} style={{ width: "70%" }}>
                        <img
                            src={`${process.env.PUBLIC_URL}/images/logged_out/kitchen/№651 05.jpg`}
                            alt=""
                        />
                    ...
                    <Grid item xs={4} style={{ width: "70%" }}>
                        <img
                            src={`${process.env.PUBLIC_URL}/images/logged_out/kitchen/№651 06.jpg`}
                            alt=""
                        />
                        <Typography variant="body1" className="text-uppercase">
                            LED-lit buttons
                    ...
                    <Grid item xs={4} style={{ width: "70%" }}>
                        <img
                            src={`${process.env.PUBLIC_URL}/images/logged_out/kitchen/№651 07.jpg`}
                            alt=""
                        />
                        <Typography variant="body1" className="text-uppercase">
                            Push-button opening
                    ...
                    <Grid item xs={7}>
                        ...
                        >
                            <ul className="p-0 list-style-3">
                                ...
                                <li>Push-button temperature setting (40°/ 60°/ 80°/ 90°/ boiling / temp control) – perfect for baby food or delicate green tea</li>
                                <li>Illuminated LED buttons</li>
                                <li>Glass housing for natural, unadulterated taste</li>
                                <li>BPA free</li>
                                <li>Capacity 1.7 l</li>
                                <li>Temp control for 30 minutes</li>
                                <li>Push-button lid opens 90° for easy cleaning</li>
                                <li>360° swivel base and water level indicator on both sides for right-handed and left-handed users</li>
                                ...
                                <li>Auto shut-off after 30 minutes temp control, or when lifted off base</li>
